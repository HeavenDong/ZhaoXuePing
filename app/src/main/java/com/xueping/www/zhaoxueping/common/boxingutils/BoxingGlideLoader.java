...
package com.xueping.www.zhaoxueping.common.boxingutils;
...
public class BoxingGlideLoader implements IBoxingMediaLoader {
    ...
    public void displayThumbnail(@NonNull ImageView img, @NonNull String absPath, int width, int height) {
        ...
        try {
            ...
            Glide.with(img.getContext()).load(path).placeholder(R.mipmap.ic_boxing_default_image).crossFade()
    ...
    @Override
    public void displayRaw(@NonNull final ImageView img, @NonNull String absPath, int width, int height, final
    IBoxingCallback callback) {
        String path = "file://" + absPath;
